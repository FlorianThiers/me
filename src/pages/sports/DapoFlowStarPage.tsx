        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">{benefits.map((benefit, index) => (
                ...
                >
                  <h3 className="text-xl font-bold text-neon-green mb-3">{benefit.title}
                  </h3>
                  <p className="text-white/70 leading-relaxed">{benefit.description}
                  </p>
                </motion.div>
              ))}
            </div>
          </div>{/* Personal Experience Section */}
          <div className="text-center">
