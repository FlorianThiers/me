...
// ${t('music.codeComments.useShortcuts')}`;
  ...
  return (
    <div className="min-h-screen text-white py-20">
      <div className="max-w-7xl mx-auto px-4">{/* Header */}
        <motion.div
        ...
        >
          <h1 className="text-5xl font-bold text-white mb-6">{t('music.title')}
          </h1>
          <p className="text-xl text-white/70 max-w-4xl mx-auto leading-relaxed">{t('music.subtitle')}
          </p>
        </motion.div>{/* Back to Home */}
        <motion.div
          ...
          <div className="bg-dark-secondary/50 backdrop-blur-sm border border-white/10 rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white flex items-center">
                <Code className="w-6 h-6 mr-3 text-neon-green" />{t('music.liveCodingPanel')}
              </h2>
                 ...
                 >{isFullscreen ? (
                   ...
                   <span className="hidden sm:inline">{isFullscreen ? t('music.exit') : t('music.fullscreen')}
                   </span>
                 </button>
               </div>
            </div>{/* Enhanced Code Editor with Visualizers */}
              <div className={`mb-6 ${isFullscreen ? 'fixed inset-0 z-50 bg-dark-bg' : ''}`}>
                <div className={`bg-dark-bg rounded-lg p-4 border border-white/10 ${isFullscreen ? 'h-full overflow-y-auto max-h-screen' : ''}`}>{/* Beat Grid Visualizer */}
                 <div className="mb-4">
                   <div className="flex items-center space-x-2 mb-2">
                     <span className="text-white/70 text-sm">{t('music.beatGrid')}</span>
                     <div className="flex space-x-1">{Array.from({ length: 8 }, (_, i) => (
                         <div
                           key={i}
                 ...
                 </div>{/* Sound Wave Visualizer */}
                 <div className="mb-4">
                   <div className="flex items-center space-x-2 mb-2">
                     <span className="text-white/70 text-sm">{t('music.soundWaves')}</span>
                   </div>
                   <div className="flex items-end space-x-1 h-16">{visualizerData.map((height, i) => (
                       <motion.div
                         key={i}
                  ...
                  <div className="relative">{/* Shortcuts Info */}
                    <div className="absolute top-2 right-2 z-20 text-xs text-white/50 bg-black/20 px-2 py-1 rounded">
                      <div>Ctrl+S / Ctrl+Enter</div>{isFullscreen && <div>ESC to exit</div>}
                    </div>
                    ...
                    <div className="absolute inset-0 pointer-events-none overflow-hidden rounded">
                      <div className="absolute inset-0 opacity-5">{Array.from({ length: 20 }, (_, i) => (
                          <motion.div
                            key={i}
                  ...
                  <div className="mt-4">
                    ...
                    <div className="grid grid-cols-4 gap-2">{['Kick', 'Snare', 'HiHat', 'Bass'].map((instrument, i) => (
                        <motion.div
                          key={instrument}
             ...
             <div className="flex items-center justify-between mb-6">
               <div className="flex items-center space-x-4">
                ...
                </button>{/* Fullscreen Close Button (only visible in fullscreen) */}
                {isFullscreen && (
                  <button
                    onClick={toggleFullscreen}
                    className="flex items-center space-x-2 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300"
            ...
            <div className="bg-dark-bg rounded-lg p-4 border border-white/10">
              ...
              <div className="text-green-400 font-mono text-sm">{output}
              </div>
            </div>
          </div>
        </motion.div>{/* Music Skills Grid */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-6">{t('music.musicSkills')}
            </h2>
            <p className="text-lg text-white/80 max-w-3xl mx-auto">{t('music.skillsSubtitle')}
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{/* DAW Software */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-neon-green transition-colors duration-300">{t('music.dawSoftware.title')}
                </h3>
                <p className="text-white/70 text-sm leading-relaxed mb-4">{t('music.dawSoftware.description')}
                </p>
                <div className="space-y-2 text-left">{(t('music.dawSoftware.items', { returnObjects: true }) as string[]).map((item, idx) => (
            ...
            >
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-neon-green transition-colors duration-300">{t('music.analogHardware.title')}
                </h3>
                <p className="text-white/70 text-sm leading-relaxed mb-4">{t('music.analogHardware.description')}
                </p>
                <div className="space-y-2 text-left">{(t('music.analogHardware.items', { returnObjects: true }) as string[]).map((item, idx) => (
                    <div key={idx} className="flex items-center space-x-2 text-sm text-white/80">
                      <span className={`w-2 h-2 ${idx === 0 ? 'bg-neon-green' : idx === 1 ? 'bg-neon-blue' : 'bg-neon-purple'} rounded-full`}></span>
                      <span>{item}</span>
                    </div>
            ...
            >
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-neon-green transition-colors duration-300">{t('music.acousticLive.title')}
                </h3>
                <p className="text-white/70 text-sm leading-relaxed mb-4">{t('music.acousticLive.description')}
                </p>
                <div className="space-y-2 text-left">{(t('music.acousticLive.items', { returnObjects: true }) as string[]).map((item, idx) => (
                    <div key={idx} className="flex items-center space-x-2 text-sm text-white/80">
                      <span className={`w-2 h-2 ${idx === 0 ? 'bg-neon-green' : idx === 1 ? 'bg-neon-blue' : 'bg-neon-purple'} rounded-full`}></span>
                      <span>{item}</span>
                    </div>
            ...
            </motion.div>{/* Vocals & Sound Design */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-neon-green transition-colors duration-300">{t('music.vocalsSoundDesign.title')}
                </h3>
                <p className="text-white/70 text-sm leading-relaxed mb-4">{t('music.vocalsSoundDesign.description')}
                </p>
                <div className="space-y-2 text-left">{(t('music.vocalsSoundDesign.items', { returnObjects: true }) as string[]).map((item, idx) => (
                    <div key={idx} className="flex items-center space-x-2 text-sm text-white/80">
                      <span className={`w-2 h-2 ${idx === 0 ? 'bg-neon-green' : idx === 1 ? 'bg-neon-blue' : 'bg-neon-purple'} rounded-full`}></span>
                      <span>{item}</span>
                    </div>
            ...
            </motion.div>{/* Live Coding & Algorave */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-neon-green transition-colors duration-300">{t('music.liveCodingAlgorave.title')}
                </h3>
                <p className="text-white/70 text-sm leading-relaxed mb-4">{t('music.liveCodingAlgorave.description')}
                </p>
                <div className="space-y-2 text-left">{(t('music.liveCodingAlgorave.items', { returnObjects: true }) as string[]).map((item, idx) => (
                    <div key={idx} className="flex items-center space-x-2 text-sm text-white/80">
                      <span className={`w-2 h-2 ${idx === 0 ? 'bg-neon-green' : idx === 1 ? 'bg-neon-blue' : 'bg-neon-purple'} rounded-full`}></span>
                      <span>{item}</span>
                    </div>
            ...
            </motion.div>{/* Music Theory & Production */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-neon-green transition-colors duration-300">{t('music.theoryProduction.title')}
                </h3>
                <p className="text-white/70 text-sm leading-relaxed mb-4">{t('music.theoryProduction.description')}
                </p>
                <div className="space-y-2 text-left">{(t('music.theoryProduction.items', { returnObjects: true }) as string[]).map((item, idx) => (
                    <div key={idx} className="flex items-center space-x-2 text-sm text-white/80">
                      <span className={`w-2 h-2 ${idx === 0 ? 'bg-neon-green' : idx === 1 ? 'bg-neon-blue' : 'bg-neon-purple'} rounded-full`}></span>
                      <span>{item}</span>
                    </div>
