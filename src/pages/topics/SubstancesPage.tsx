...
export const SubstancesPage: React.FC = () =>{
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">{/* Decoratieve achtergrond elementen */}
      <div 
      ...
      <div className="container-custom px-4 py-8 relative z-10">{/* Header */}
        <div className="text-center mb-16">
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 neon-text">{t('substances.title')}
            </h1>
            <p className="text-lg text-white/80 max-w-4xl mx-auto leading-relaxed">{t('substances.subtitle')}
            </p>
        ...
        <div className="max-w-6xl mx-auto mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-6">{t('substances.mainTitle')}
            </h2>
            <p className="text-lg text-white/80 max-w-3xl mx-auto">{t('substances.mainDescription')}
            </p>
          </motion.div>{/* Substances Grid */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">{substances.map((substance, index) => (
              <motion.div
                key={substance.key}
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >{/* Header */}
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">{substance.name}
                  </h3>
                  <span className="inline-block px-3 py-1 bg-dark-bg/50 rounded-full text-xs text-neon-blue border border-neon-blue/30">{substance.category}
                  </span>
                </div>{/* Effect */}
                <div className="mb-4">
                  <h4 className="text-neon-green font-semibold mb-2 flex items-center">
                    <Brain className="w-4 h-4 mr-2" />{t('substances.effectOnMind')}
                  </h4>
                  <p className="text-white/70 text-sm leading-relaxed">{substance.effect}
                  </p>
                </div>{/* Computer Equivalent */}
                <div className="mb-4">
                  <h4 className="text-neon-blue font-semibold mb-2 flex items-center">
                    <Lightbulb className="w-4 h-4 mr-2" />{t('substances.computerEquivalent')}
                  </h4>
                  <p className="text-white/70 text-sm leading-relaxed">{substance.computerEquivalent}
                  </p>
                </div>{/* Benefits & Risks */}
                <div className="grid grid-cols-1 gap-4 mb-4">
                  <div>
                    <h4 className="text-neon-green font-semibold mb-2 flex items-center">
                      <Users className="w-4 h-4 mr-2" />{t('substances.benefits')}
                    </h4>
                    <ul className="space-y-1">{substance.benefits.map((benefit, idx) => (
                  ...
                  <div>
                    <h4 className="text-neon-pink font-semibold mb-2 flex items-center">
                      <AlertTriangle className="w-4 h-4 mr-2" />{t('substances.risks')}
                    </h4>
                    <ul className="space-y-1">{substance.risks.map((risk, idx) => (
                        <li key={idx} className="text-white/70 text-xs flex items-start space-x-2">
                ...
                <div className="space-y-3">
                  <div className="bg-dark-bg/30 rounded-lg p-3 border border-white/10">
                    <h4 className="text-neon-purple font-semibold mb-2 flex items-center">
                      <BookOpen className="w-4 h-4 mr-2" />{t('substances.research')}
                    </h4>
                    <p className="text-white/70 text-xs leading-relaxed">{substance.research}
                    </p>
                  </div>
        ...
        >
          <p className="text-white/70 mb-6 text-lg">{t('substances.cta')}
          </p>
          <motion.div
